        ...
        <div class="row g-4 footer-main">
            <div class="col-lg-4">
                ...
                <p class="footer-description">
                    El poder de participar comienza aquí. Plataforma oficial con respaldo,
                    transparencia y seguridad en cada dinámica.
                </p>
            </div>
            ...
            <div class="col-6 col-lg-2">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="#comprobantes">Pagos verificados</a></li>
            ...
            <div class="col-6 col-lg-3">
                ...
                <ul class="footer-contact">
                    <li>
                        <a href="tel:+573202925348">
                            <i class="bi bi-telephone"></i> (+57) 320 292 5348
                        </a>
                    </li>
                    <li>
                        <a href="mailto:<?= $email ?>">
                            <i class="bi bi-envelope"></i> info@apfenix.com
                        </a>
                    </li>
                    <li>
